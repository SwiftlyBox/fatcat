            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-body-color mb-7 text-base">
                  The food delivery platform for all types of restaurants and
                  sizes.
                </p>
                  ...
                  <li>
                    <Link href="SwiftlyDriver">
                      <a
                        ...
                        className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                      >
                        Become A Swiftly Driver
                      </a>
                    </Link>
                  </li>
                  <li>
                    <Link href="swiftlytraining">
                      <a
                        href="javascript:void(0)"
                        className="text-body-color hover:text-primary mb-2 inline-block text-base leading-loose"
                      >
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <div className="mb-6 flex items-center">
                  <a
                    href="https://www.facebook.com/profile.php?id=100083350375456"
                  ...
                  <a
                    href="https://twitter.com/swiftlybox"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="16"
                  ...
                  <a
                    href="https://www.linkedin.com/company/swiftlybox/?viewAsMember=true"
                    className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width="14"
                ...
                <p className="text-body-color text-base">
                  SwiftlyBox Technologies Pty Ltd .All Rights Reserved.
                </p>
              </div>
            </div>
          </div>
