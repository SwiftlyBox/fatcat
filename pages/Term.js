  ...
  return (
    <>
      ...
      <p>
        ...
        of Swiftly Box {"Inc"} Website, located at https://swiftlybox.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use swiftlybox.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing swiftlybox.com, you agreed to
        use cookies in agreement with the Swiftly Box {"Inc"} Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Swiftly Box Inc and/or its licensors own the
        intellectual property rights for all material on swiftlybox.com. All
        intellectual property rights are reserved. You may access this from
        swiftlybox.com for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        Swiftly Box Inc does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Swiftly Box Inc,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Swiftly Box Inc
      ...
      <p>
        Swiftly Box Inc reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Swiftly Box Inc a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Swiftly Box Inc; and (d) the
      ...
      <p>
        ...
        e-mail to Swiftly Box Inc. Please include your name, your organization
      ...
      <p>
        No use of Swiftly Box {"Inc"} logo or other artwork will be allowed for
      ...
      <p>
        We do collect information for our services to work such as your email
        address,phone number,location of delivery and also we collect your
        banking information using Paystack and Flutterwave to make that chain
        secure .
      </p>
